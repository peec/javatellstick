...
import pkj.no.tellstick.JNA.DataType;
import pkj.no.tellstick.JNA.Method;
import pkj.no.tellstick.device.iface.SensorListener;
import pkj.no.tellstick.device.iface.DeviceChangeListener;
...
public class TellsticEventHandler {
	...
	private static final Logger logger = Logger
			.getLogger(TellsticEventHandler.class.getName());
